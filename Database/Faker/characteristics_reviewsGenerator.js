...
const filename = argv.filename || '/Users/thomas/git-hackreactor/systemDesignCapstone/full/ratings-reviews/Database/csvFiles/generated-characteristics_reviews.csv';
...
const createCharacteristics_reviewsEntry = () => (`${characteristics_reviewsPK},${characteristicsPK},${reviewsPK},${faker.random.number({ min: 1, max: 5 })}\n`);
...
const startGenerator = (writeStream, encoding, done) => {
    ...
    function generate() {
        ...
        do {
            ...
            let entry = createCharacteristics_reviewsEntry();
            if (i === 0) {
