...
const filename = argv.filename || '/Users/thomas/git-hackreactor/systemDesignCapstone/full/ratings-reviews/Database/csvFiles/generated-reviews_photos.csv';
...
const createReviews_photosEntry = () => (`${reviews_photosPK},${reviewsPK},"${faker.image.avatar()}"\n`);
...
const startGenerator = (writeStream, encoding, done) => {
    ...
    function generate() {
        ...
        do {
            ...
            let entry = createReviews_photosEntry();
            if (i === 0) {
